...
female.pop=SO2012Ctry$Female/(SO2012Ctry$Female+SO2012Ctry$Male)
...
total_athletes=SO2012Ctry$Female+SO2012Ctry$Male
plot(total_athletes,female.pop,xlab="Total # athletes",ylab="Proportion of female athletes",main="Proportion of female athletes vs Total # athletes",lwd=10)
